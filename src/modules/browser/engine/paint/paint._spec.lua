...
describe('paint', function()
  ...
  describe('border', function()
    it('Should create a border around the component', function()
      ...
      assert.same(3, utf8.len(result[2].value))
      assert.same(3, utf8.len(result[3].value))
      assert.same(#'hello' + 2, utf8.len(result[4].value))
      assert.same(#'hello' + 2, utf8.len(result[5].value))
